...
const companyRoutes = require('./routes/company'); // ⭐ 组织路由
const wikiRoutes = require('./routes/wiki'); // ⭐ Wiki路由
...
app.use('/api/company', companyRoutes); // ⭐ 组织路由
app.use('/api/wiki', wikiRoutes); // ⭐ Wiki路由
